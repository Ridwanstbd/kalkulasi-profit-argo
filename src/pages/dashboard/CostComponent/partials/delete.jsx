...
const DeleteComponentModal = ({ isOpen, onClose, id, onDeleted }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.error("Error Deleting componen:", error);
      showAlert(
  ...
  return (
    <ModalDelete
      ...
      message="Apakah kamu yakin ingin menghapus komponen ini?"
